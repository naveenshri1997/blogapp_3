...
const BlogTitleContainer = ({blogs}) => {
    const url = "https://blogv3server.onrender.com";
    ...
    return (
        ...
        <Link className='cus_link' to={`/blog/${blogs._id}`}>
            <div className='blog_container'>
                ...
                <div className='blog_detail row'>
                        <div className="bdp2 col-lg-3 col-md-2 col-3" style={padd}>
                            <img src={`${url}/${blogs.image.slice(14)}`} className='img-fluid' alt="" />
                        </div>
                        <div className='bdp1 col-lg-8 col-md-9 col-9'>
